(() => {
  ...
  var require_google_protobuf = __commonJS((exports) => {
    var $jscomp = $jscomp || {};
    $jscomp.scope = {};
  ...
  // src/greeting/v1/greeting_pb.js
  var require_greeting_pb = __commonJS((exports2) => {
    var jspb2 = require_google_protobuf();
    var goog2 = jspb2;
    var global2 = Function("return this")();
    goog2.exportSymbol("proto.greeting.v1.GreetRequest", null, global2);
    goog2.exportSymbol("proto.greeting.v1.GreetResponse", null, global2);
    proto.greeting.v1.GreetRequest = function(opt_data) {
      jspb2.Message.initialize(this, opt_data, 0, -1, null, null);
    };
    goog2.inherits(proto.greeting.v1.GreetRequest, jspb2.Message);
    if (goog2.DEBUG && !COMPILED) {
      proto.greeting.v1.GreetRequest.displayName = "proto.greeting.v1.GreetRequest";
    }
    proto.greeting.v1.GreetResponse = function(opt_data) {
      jspb2.Message.initialize(this, opt_data, 0, -1, null, null);
    };
    goog2.inherits(proto.greeting.v1.GreetResponse, jspb2.Message);
    if (goog2.DEBUG && !COMPILED) {
      proto.greeting.v1.GreetResponse.displayName = "proto.greeting.v1.GreetResponse";
    }
    if (jspb2.Message.GENERATE_TO_OBJECT) {
      proto.greeting.v1.GreetRequest.prototype.toObject = function(opt_includeInstance) {
        return proto.greeting.v1.GreetRequest.toObject(opt_includeInstance, this);
      };
      proto.greeting.v1.GreetRequest.toObject = function(includeInstance, msg) {
        var f, obj = {};
        if (includeInstance) {
    ...
    proto.greeting.v1.GreetRequest.deserializeBinary = function(bytes) {
      var reader = new jspb2.BinaryReader(bytes);
      var msg = new proto.greeting.v1.GreetRequest();
      return proto.greeting.v1.GreetRequest.deserializeBinaryFromReader(msg, reader);
    };
    proto.greeting.v1.GreetRequest.deserializeBinaryFromReader = function(msg, reader) {
    ...
    proto.greeting.v1.GreetRequest.prototype.serializeBinary = function() {
      var writer = new jspb2.BinaryWriter();
      proto.greeting.v1.GreetRequest.serializeBinaryToWriter(this, writer);
      return writer.getResultBuffer();
    };
    proto.greeting.v1.GreetRequest.serializeBinaryToWriter = function(message, writer) {
      var f = void 0;
    };
    if (jspb2.Message.GENERATE_TO_OBJECT) {
      proto.greeting.v1.GreetResponse.prototype.toObject = function(opt_includeInstance) {
        return proto.greeting.v1.GreetResponse.toObject(opt_includeInstance, this);
      };
      proto.greeting.v1.GreetResponse.toObject = function(includeInstance, msg) {
        var f, obj = {
    ...
    proto.greeting.v1.GreetResponse.deserializeBinary = function(bytes) {
      var reader = new jspb2.BinaryReader(bytes);
      var msg = new proto.greeting.v1.GreetResponse();
      return proto.greeting.v1.GreetResponse.deserializeBinaryFromReader(msg, reader);
    };
    proto.greeting.v1.GreetResponse.deserializeBinaryFromReader = function(msg, reader) {
      while (reader.nextField()) {
        if (reader.isEndGroup()) {
          break;
        }
    ...
    proto.greeting.v1.GreetResponse.prototype.serializeBinary = function() {
      var writer = new jspb2.BinaryWriter();
      proto.greeting.v1.GreetResponse.serializeBinaryToWriter(this, writer);
      return writer.getResultBuffer();
    };
    proto.greeting.v1.GreetResponse.serializeBinaryToWriter = function(message, writer) {
      var f = void 0;
    ...
    proto.greeting.v1.GreetResponse.prototype.getMessage = function() {
      return jspb2.Message.getFieldWithDefault(this, 1, "");
    };
    proto.greeting.v1.GreetResponse.prototype.setMessage = function(value) {
      return jspb2.Message.setProto3StringField(this, 1, value);
    };
    goog2.object.extend(exports2, proto.greeting.v1);
  });

  // node_modules/grpc-web/index.js
  var require_grpc_web = __commonJS((exports2, module2) => {
    function aa(a) {
      var b = 0;
      return function() {
  ...
  // src/main.ts
  var import_greeting_pb = __toModule(require_greeting_pb());

  // src/greeting/v1/GreetingServiceClientPb.ts
  var grpcWeb = __toModule(require_grpc_web());
  var greeting_v1_greeting_pb = __toModule(require_greeting_pb());
  var GreetingServiceClient = class {
    constructor(hostname, credentials, options) {
      this.methodInfoGreet = new grpcWeb.AbstractClientBase.MethodInfo(greeting_v1_greeting_pb.GreetResponse, (request) => {
    ...
    greet(request, metadata, callback) {
      if (callback !== void 0) {
        return this.client_.rpcCall(this.hostname_ + "/greeting.v1.GreetingService/Greet", request, metadata || {}, this.methodInfoGreet, callback);
      }
      return this.client_.unaryCall(this.hostname_ + "/greeting.v1.GreetingService/Greet", request, metadata || {}, this.methodInfoGreet);
    }
  };
